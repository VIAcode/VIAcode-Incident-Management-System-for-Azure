...
Compress-Archive -Path "$scriptDir\Zammad\AppService\*" -DestinationPath $vimszfree -Force
...
Compress-Archive -Path $zammadconnector -DestinationPath $vimszfree -Update
```
