...
Setting.create_if_not_exists(
  ...
  area:        'Core::WebApp',
  description: 'Enable or disable the maintenance mode. If enabled, all non-administrators get logged out and only administrators can start a new session.',
  options:     {},
  state:       false,
  preferences: {
...
Setting.create_if_not_exists(
  ...
  state:       'VIAcode Incident Management',
  frontend:    true
)
Setting.create_if_not_exists(
  title:       'Logo',
