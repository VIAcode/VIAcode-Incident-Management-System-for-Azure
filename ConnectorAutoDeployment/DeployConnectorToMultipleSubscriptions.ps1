        ...
        if ($managedApp) {
            ...
            if ($selectedSubscriptions) {
                ...
                if ($location) {
                    ...
                    $terms = Get-AzMarketplaceTerms -Publisher "viacode_consulting-1089577" -Product "viacode-vims-preview" -Name "vims-paid"
                        
                    $input = Read-Host "`nBy deploying alert connector via this script you automatically accept the following:`n`nTerms of use: https://catalogartifact.azureedge.net/publicartifacts/viacode_consulting-1089577.viacode-vims-preview-aefc5caa-174f-49fe-97c5-22e9c894ab2d/termsOfUse.html`nPrivacy policy: $($terms.PrivacyPolicyLink)`nAzure Marketplace Terms: https://azure.microsoft.com/support/legal/marketplace-terms/`n`nDo you want to proceed? (Y/N)"
                    ...
                    if ($input -eq 'y') {
                        ...
                        $selectedSubscriptions | ForEach-Object {
                            ...
                            Get-AzMarketplaceTerms -Publisher "viacode_consulting-1089577" -Product "viacode-vims-preview" -Name "vims-paid" | Set-AzMarketplaceTerms -Accept | Out-Null
