                ...
                if ($location) {
                    ...
                    if ($input -eq 'y') {
                        ...
                        $selectedSubscriptions | ForEach-Object {
                            ...
                            Get-AzMarketplaceTerms -Publisher "viacode_consulting-1089577" -Product "viacode-itsm-z-preview" -Name "vims-connector-azure-monitor" | Set-AzMarketplaceTerms -Accept | Out-Null
